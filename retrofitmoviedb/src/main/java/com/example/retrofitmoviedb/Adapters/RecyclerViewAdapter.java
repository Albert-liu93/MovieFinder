package com.example.retrofitmoviedb.Adapters;
...
import com.example.retrofitmoviedb.R;
import com.example.retrofitmoviedb.Utils;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Utils.getMovieDetails(movieId, mContext);
                }
            }
        );
    }
